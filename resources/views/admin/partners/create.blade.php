    ...
    <div class="lg:col-span-2">
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.partners.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 font-semibold mb-2">Partner Name</label>
    ...
    <div>
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-gray-600 text-sm">
                Add a new partner to the system. Partners can be assigned vehicles and participate in campaigns.
            </p>
        </div>
    </div>
</div>
