            ...
            <form action="{{ route('admin.transactions.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="payment_channel" id="payment_channel" value="{{ old('payment_channel') }}" 
                               class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="payment_notes" id="payment_notes" rows="4" 
                              class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('payment_notes') }}</textarea>
                    @error('payment_notes')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
    ...
    <div>
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-gray-600 text-sm">
                Record a new transaction. Link it to an advertisement and a customer, then enter payment details and status.
            </p>
        </div>
    </div>
</div>
