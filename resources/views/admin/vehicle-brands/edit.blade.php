...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold">Edit Vehicle Brand</h1>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div>
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.vehicle-brands.update', $brand->id) }}" method="POST">
                @csrf
                @method('PUT')
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div>
                    ...
                    <p class="font-semibold">{{ $brand->created_at?->format('d M Y H:i') ?? 'N/A' }}</p>
                </div>
                <div>
                    <p class="text-gray-600">Updated At</p>
                    <p class="font-semibold">{{ $brand->updated_at?->format('d M Y H:i') ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
    </div>
